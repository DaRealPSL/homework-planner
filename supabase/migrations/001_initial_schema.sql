...
\restrict RxYiVoj0ekKMHip9ibMpFWyMrVsDkbCXrr9KWUSgQRIgOSESsFLoODl72egqJr7
...
--
-- Name: get_class_by_code(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_class_by_code(p_code text) RETURNS TABLE(class_id uuid, class_name text)
    LANGUAGE sql SECURITY DEFINER
    AS $$
  SELECT id, name FROM public.classes WHERE code = p_code LIMIT 1;
$$;


--
-- Name: get_user_class_id(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_user_class_id() RETURNS uuid
    LANGUAGE sql STABLE
    AS $$
...
BEGIN
  -- Get class_id from user metadata
  ...
  -- Only insert if class_id exists and profile doesn't exist yet
  IF user_class_id IS NOT NULL THEN
    INSERT INTO public.profiles (id, class_id, display_name)
    VALUES (NEW.id, user_class_id, user_display_name)
...
--
-- Name: notify_announcement_created(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.notify_announcement_created() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
  creator_name text;
BEGIN
  ...
  PERFORM notify_class_members(
    NEW.class_id,
    'announcement',
    NEW.title,
    creator_name || ': ' || LEFT(NEW.content, 100),
    NULL
  );
...
--
-- Name: notify_class_members(uuid, text, text, text, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.notify_class_members(p_class_id uuid, p_type text, p_title text, p_message text, p_homework_id uuid DEFAULT NULL::uuid) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  INSERT INTO notifications (user_id, type, title, message, homework_id)
  SELECT id, p_type, p_title, p_message, p_homework_id
  FROM profiles
...
--
-- Name: notify_homework_added(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.notify_homework_added() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
  creator_name text;
...
CREATE TABLE public.classes (
    ...
    name text,
    created_at timestamp with time zone DEFAULT now(),
    CONSTRAINT code_format CHECK ((code ~ '^[0-9]{1,2}[A-Z]{2,3}[0-9]{1,2}$'::text))
);
...
CREATE TABLE public.content_reports (
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT content_reports_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'reviewed'::text, 'resolved'::text, 'dismissed'::text])))
);
...
--
-- Name: homework_attachments; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: homework_completion; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.notifications (
    ...
    created_at timestamp with time zone DEFAULT now(),
    CONSTRAINT notifications_type_check CHECK ((type = ANY (ARRAY['homework_added'::text, 'homework_due_soon'::text, 'homework_updated'::text, 'announcement'::text])))
);
...
--
-- Name: homework_attachments homework_attachments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: homework_completion homework_completion_homework_id_user_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.homework_completion
    ADD CONSTRAINT homework_completion_homework_id_user_id_key UNIQUE (homework_id, user_id);


--
-- Name: homework_completion homework_completion_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
CREATE INDEX idx_announcements_class ON public.announcements USING btree (class_id);
...
CREATE INDEX idx_announcements_pinned ON public.announcements USING btree (pinned);
...
--
-- Name: idx_content_reports_homework; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_content_reports_homework ON public.content_reports USING btree (homework_id);
...
--
-- Name: idx_homework_attachments_homework_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_homework_attachments_homework_id ON public.homework_attachments USING btree (homework_id);


--
-- Name: idx_homework_class_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_homework_class_id ON public.homework USING btree (class_id);


--
-- Name: idx_homework_completion_homework_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_homework_completion_homework_id ON public.homework_completion USING btree (homework_id);


--
-- Name: idx_homework_completion_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_homework_completion_user_id ON public.homework_completion USING btree (user_id);
...
--
-- Name: idx_profiles_class_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: announcements on_announcement_created; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER on_announcement_created AFTER INSERT ON public.announcements FOR EACH ROW EXECUTE FUNCTION public.notify_announcement_created();


--
-- Name: homework on_homework_created; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER on_homework_created AFTER INSERT ON public.homework FOR EACH ROW EXECUTE FUNCTION public.notify_homework_added();


--
-- Name: homework_completion update_homework_completion_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_homework_completion_updated_at BEFORE UPDATE ON public.homework_completion FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: homework update_homework_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: content_reports content_reports_homework_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.content_reports
    ADD CONSTRAINT content_reports_homework_id_fkey FOREIGN KEY (homework_id) REFERENCES public.homework(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.content_reports
    ADD CONSTRAINT content_reports_reported_by_fkey FOREIGN KEY (reported_by) REFERENCES public.profiles(id) ON DELETE SET NULL;


--
-- Name: homework_attachments homework_attachments_homework_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: homework_attachments homework_attachments_uploaded_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.homework_attachments
    ADD CONSTRAINT homework_attachments_uploaded_by_fkey FOREIGN KEY (uploaded_by) REFERENCES public.profiles(id);
...
ALTER TABLE ONLY public.homework
    ADD CONSTRAINT homework_class_id_fkey FOREIGN KEY (class_id) REFERENCES public.classes(id);


--
-- Name: homework_completion homework_completion_homework_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.homework_completion
    ADD CONSTRAINT homework_completion_homework_id_fkey FOREIGN KEY (homework_id) REFERENCES public.homework(id) ON DELETE CASCADE;


--
-- Name: homework_completion homework_completion_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.homework_completion
    ADD CONSTRAINT homework_completion_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.profiles(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.homework
    ADD CONSTRAINT homework_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.profiles(id);


--
-- Name: notifications notifications_homework_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.notifications
    ADD CONSTRAINT notifications_homework_id_fkey FOREIGN KEY (homework_id) REFERENCES public.homework(id) ON DELETE CASCADE;
...
--
-- Name: profiles profiles_class_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: announcements announcements_delete_owner; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY announcements_delete_owner ON public.announcements FOR DELETE USING ((created_by = auth.uid()));


--
-- Name: announcements announcements_insert_class_with_owner; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY announcements_insert_class_with_owner ON public.announcements FOR INSERT WITH CHECK (((class_id IN ( SELECT profiles.class_id
   FROM public.profiles
  WHERE (profiles.id = auth.uid()))) AND (created_by = auth.uid())));


--
-- Name: announcements announcements_select_class; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY announcements_select_class ON public.announcements FOR SELECT USING ((class_id IN ( SELECT profiles.class_id
   FROM public.profiles
  WHERE (profiles.id = auth.uid()))));


--
-- Name: announcements announcements_update_owner; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY announcements_update_owner ON public.announcements FOR UPDATE USING ((created_by = auth.uid())) WITH CHECK ((created_by = auth.uid()));


--
-- Name: homework_attachments attachments_delete_owner; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY attachments_delete_owner ON public.homework_attachments FOR DELETE USING ((homework_id IN ( SELECT homework.id
   FROM public.homework
  WHERE (homework.created_by = auth.uid()))));


--
-- Name: homework_attachments attachments_insert_creator_only; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY attachments_insert_creator_only ON public.homework_attachments FOR INSERT WITH CHECK ((homework_id IN ( SELECT homework.id
   FROM public.homework
  WHERE (homework.created_by = auth.uid()))));


--
-- Name: homework_attachments attachments_insert_owner_only; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY attachments_insert_owner_only ON public.homework_attachments FOR INSERT WITH CHECK ((homework_id IN ( SELECT homework.id
   FROM public.homework
  WHERE (homework.created_by = auth.uid()))));


--
-- Name: homework_attachments attachments_select_class; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY attachments_select_class ON public.homework_attachments FOR SELECT USING ((homework_id IN ( SELECT homework.id
   FROM public.homework
  WHERE (homework.class_id = public.get_user_class_id()))));
...
--
-- Name: audit_logs audit_logs_insert_own; Type: POLICY; Schema: public; Owner: -
--
...
CREATE POLICY classes_member_read ON public.classes FOR SELECT USING ((id IN ( SELECT profiles.class_id
   FROM public.profiles
  WHERE (profiles.id = auth.uid()))));


--
-- Name: classes classes_select_member_only; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY classes_select_member_only ON public.classes FOR SELECT USING ((id IN ( SELECT profiles.class_id
   FROM public.profiles
  WHERE (profiles.id = auth.uid()))));


--
-- Name: homework_completion completion_delete_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY completion_delete_own ON public.homework_completion FOR DELETE USING ((user_id = auth.uid()));


--
-- Name: homework_completion completion_insert_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY completion_insert_own ON public.homework_completion FOR INSERT WITH CHECK ((user_id = auth.uid()));


--
-- Name: homework_completion completion_select_class; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY completion_select_class ON public.homework_completion FOR SELECT USING ((homework_id IN ( SELECT homework.id
   FROM public.homework
  WHERE (homework.class_id = public.get_user_class_id()))));


--
-- Name: homework_completion completion_update_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY completion_update_own ON public.homework_completion FOR UPDATE USING ((user_id = auth.uid())) WITH CHECK ((user_id = auth.uid()));
...
CREATE POLICY content_reports_insert_own ON public.content_reports FOR INSERT WITH CHECK ((reported_by = auth.uid()));
...
CREATE POLICY content_reports_select_own ON public.content_reports FOR SELECT USING ((reported_by = auth.uid()));
...
--
-- Name: homework_attachments; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.homework_attachments ENABLE ROW LEVEL SECURITY;

--
-- Name: homework_completion; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.homework_completion ENABLE ROW LEVEL SECURITY;

--
-- Name: homework homework_delete_owner; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY homework_delete_owner ON public.homework FOR DELETE USING ((created_by = auth.uid()));


--
-- Name: homework homework_insert_owner; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY homework_insert_owner ON public.homework FOR INSERT WITH CHECK ((created_by = auth.uid()));


--
-- Name: homework homework_select_class; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY homework_select_class ON public.homework FOR SELECT USING ((class_id = public.get_user_class_id()));


--
-- Name: homework homework_update_owner; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY homework_update_owner ON public.homework FOR UPDATE USING ((created_by = auth.uid())) WITH CHECK ((created_by = auth.uid()));
...
--
-- Name: profiles profiles_block_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY profiles_block_delete ON public.profiles FOR DELETE USING (false);
...
--
-- Name: supabase_realtime homework; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.homework;


--
-- Name: supabase_realtime homework_attachments; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.homework_attachments;


--
-- Name: supabase_realtime homework_completion; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.homework_completion;
...
\unrestrict RxYiVoj0ekKMHip9ibMpFWyMrVsDkbCXrr9KWUSgQRIgOSESsFLoODl72egqJr7
